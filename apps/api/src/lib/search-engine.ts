/**
 * XPS Intelligence — Real Search Engine (API-embedded copy)
 *
 * Priority chain:
 ...
 *
 * This file is a self-contained copy of services/scraper/src/search-engine.ts
 * embedded inside apps/api so it is included in the production Docker image
 * (apps/api/dist/) without requiring a cross-package dynamic import.
 */
